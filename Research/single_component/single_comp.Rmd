...
# sets = c(1, 6, 11, 16, 21, 26, 31, 36, 41, 46)
# 
# for (set in sets) {
#   for (n in ns) {
#     filename =  glue("./comp_outputs/skew_norm/1d/t_posterior-single_skew_normal_1d-n={n}-alpha=0-set-{set}.jld")
#     to_filename =  glue("./comp_outputs/skew_norm/1d/t_posterior-single_skew_normal_1d-alpha=0-n={n}-set-{set}.jld")
#     file.rename(filename, to_filename)
#   }
# }
```
...
for (i_n in seq_along(ns)) {
  ...
  for (i_set in seq_along(sets)) {
    set = sets[i_set]
    filename =  glue("./comp_outputs/skew_norm/1d/k_posterior-single_skew_normal_1d-alpha=5-n={n}-set-{set}.jld")
    k_posterior = h5read(filename, "k_posterior")
    pmf[, i_set] = k_posterior[1:m]
  }
...
for (i_n in seq_along(ns)) {
  ...
  for (i_set in seq_along(sets)) {
    set = sets[i_set]
    filename = glue("./comp_outputs/skew_norm/1d/k_posterior-single_skew_normal_1d-alpha=2-n={n}-set-{set}.jld")
    k_posterior = h5read(filename, "k_posterior")
    pmf[, i_set] = k_posterior[1:m]
  }
...
for (i_n in seq_along(ns)) {
  ...
  for (i_set in seq_along(sets)) {
    set = sets[i_set]
    filename = glue("./comp_outputs/skew_norm/1d/k_posterior-single_skew_normal_1d-alpha=7-n={n}-set-{set}.jld")
    k_posterior = h5read(filename, "k_posterior")
    pmf[, i_set] = k_posterior[1:m]
  }
...
for (i_n in seq_along(ns)) {
  ...
  for (i_set in seq_along(sets)) {
    set = sets[i_set]
    filename = glue("./comp_outputs/skew_norm/1d/k_posterior-single_skew_normal_1d-alpha=0-n={n}-set-{set}.jld")
    k_posterior = h5read(filename, "k_posterior")
    pmf[, i_set] = k_posterior[1:m]
  }
...
for (i_n in seq_along(ns)) {
  ...
  for (i_set in seq_along(sets)) {
    set = sets[i_set]
    filename = glue("./comp_outputs/skew_norm/1d/k_posterior-single_skew_normal_1d-alpha=1-n={n}-set-{set}.jld")
    k_posterior = h5read(filename, "k_posterior")
    pmf[, i_set] = k_posterior[1:m]
  }
...
for (alpha in alphas) {
  for (n in ns) {
    for (set in sets) {
      from_name = glue("./comp_outputs/skew_norm/2d/k_posterior_single_skew_normal_alpha={alpha}_2d_n={n}-set-{set}.jld")
      to_name = glue("./comp_outputs/skew_norm/2d/k_posterior-single_skew_normal_2d-alpha={alpha}-n={n}-set-{set}.jld")
...
df = as.data.frame(h5read("./data_inputs/laplace/2d/single_laplace_1d-sigma=1-set-8.jld", "data"))
# df = rbind(data1, data2)
df %>% ggplot(aes(x = V1)) + geom_density()
```
...
df = as.data.frame(h5read("./data_inputs/laplace/1d/single_laplace_1d-lambda=3-set-8.jld", "data"))
colnames(df) = c("x")
# df = rbind(data1, data2)
...
df = as.data.frame(h5read("./data_inputs/laplace/2d/single_laplace_2d-sigma=1-set-8.jld", "data"))
# df = as.data.frame(data)
df %>% ggplot(aes(x = V1, y=V2)) + geom_point()

df = as.data.frame(h5read("./data_inputs/laplace/2d/single_laplace_2d-sigma=2-set-8.jld", "data"))
# df = as.data.frame(data)
df %>% ggplot(aes(x = V1, y=V2)) + geom_point()

df = as.data.frame(h5read("./data_inputs/laplace/2d/single_laplace_2d-sigma=3-set-8.jld", "data"))
# df = as.data.frame(data)
df %>% ggplot(aes(x = V1, y=V2)) + geom_point()

df = as.data.frame(h5read("./data_inputs/laplace/2d/single_laplace_2d-sigma=4-set-8.jld", "data"))
# df = as.data.frame(data)
df %>% ggplot(aes(x = V1, y=V2)) + geom_point()

df = as.data.frame(h5read("./data_inputs/laplace/2d/single_laplace_2d-sigma=5-set-8.jld", "data"))
# df = as.data.frame(data)
df %>% ggplot(aes(x = V1, y=V2)) + geom_point()
