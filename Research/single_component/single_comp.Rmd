...
for (i_n in seq_along(ns)) {
  ...
  for (i_set in seq_along(sets)) {
    set = sets[i_set]
    filename =  glue("./comp_outputs/skew_norm/2d/k_posterior-single_skew_normal_2d-alpha=5-n={n}-set-{set}.jld")
...
for (i_n in seq_along(ns)) {
  ...
  for (i_set in seq_along(sets)) {
    set = sets[i_set]
    filename = glue("./comp_outputs/skew_norm/2d/k_posterior-single_skew_normal_2d-alpha=2-n={n}-set-{set}.jld")
    k_posterior = h5read(filename, "k_posterior")
    pmf[, i_set] = k_posterior[1:m]
  }
...
for (i_n in seq_along(ns)) {
  ...
  for (i_set in seq_along(sets)) {
    set = sets[i_set]
    filename = glue("./comp_outputs/skew_norm/2d/k_posterior-single_skew_normal_2d-alpha=7-n={n}-set-{set}.jld")
    k_posterior = h5read(filename, "k_posterior")
    pmf[, i_set] = k_posterior[1:m]
  }
...
for (i_n in seq_along(ns)) {
  ...
  for (i_set in seq_along(sets)) {
    set = sets[i_set]
    filename = glue("./comp_outputs/skew_norm/2d/k_posterior-single_skew_normal_2d-alpha=0-n={n}-set-{set}.jld")
    k_posterior = h5read(filename, "k_posterior")
    pmf[, i_set] = k_posterior[1:m]
  }
...
for (i_n in seq_along(ns)) {
  ...
  for (i_set in seq_along(sets)) {
    set = sets[i_set]
    filename = glue("./comp_outputs/skew_norm/2d/k_posterior-single_skew_normal_2d-alpha=1-n={n}-set-{set}.jld")
    k_posterior = h5read(filename, "k_posterior")
    pmf[, i_set] = k_posterior[1:m]
  }
